...
void GameState::draw()
{
    ...
    fbo.copyTo(fbo1);
    fbo.blur(0, 1, get_uniform_data<int>("glowRadius"), 
        get_uniform_data<float>("glowMultiplier"), get_uniform_data<int>("isHDR"));

    fbo1.blur(0, 0, get_uniform_data<int>("blurRadius"), 
        get_uniform_data<float>("blurMultiplier"), get_uniform_data<int>("isHDR"));
